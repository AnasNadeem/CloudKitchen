...
class CloudKitchen:
    ...
    def new_orders(self, order):
        ...
        for order_id,order_items in order.items():
            ...
            for item in order_items:
                self.order_queue[order_id][f"{item}"] = self.menu_items[f"{item}"]['prep_time']
    ...
    def update_order_stove(self, stove_id):
        ...
        first_order_id =  next(iter(self.order_queue.keys()))
        ...
        self.order_on_stove[f'{first_order_id}'][f'{first_item_in_order_queue}'] = self.menu_items[f'{first_item_in_order_queue}']['prep_time']
